...
graphics.off()
# Importando os dados
IBOV_Data <- read_excel(
  "C:/Users/josez/Desktop/Economia/FEA/TCC/dados/Comp_IBOV.xlsx"
  )
...
df_IBOV<-BatchGetSymbols(tickers_Yah,first.date = datainicial,last.date = datafinal,thresh.bad.data = .70)
...
save(
  list=ls(),
  file="C:/Users/josez/Desktop/Economia/FEA/TCC/dados/IbovData_2.RDS"
  )
